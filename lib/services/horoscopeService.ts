...
const RASI = ["Mesham","Rishabam","Mithunam","Kadagam","Simmam","Kanni","Thulam","Viruchigam","Dhanusu","Makaram","Kumbam","Meenam"] as const
...
export async function generateHoroscope(input:{
  ...
  const jd = swisseph.swe_julday(
    ...
    dt.hour() + dt.minute()/60, swisseph.SE_GREG_CAL
  )
